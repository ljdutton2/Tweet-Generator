...
class Listogram:
    ...
    def build_listogram(self): 
      ...
      # use your listogram function as a starting point to complete this method
      list_histogram = []
    ...
    def get_index(self, word, list_histogram):
        ...
        #use your get_index function as a starting point to complete this method
        current_index = 0
    ...
    def frequency(self, word):
        ...
        #use your frequency and get_index function as a starting point to complete this method
    ...
    def sample(self):
        ...
        #You will need to adapt it a little bit to work with listogram
        tokens = sum([count for word,count in self.list_histogram])
